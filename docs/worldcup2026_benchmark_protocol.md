...
**Document purpose:** This document defines the scientific/source-of-truth protocol for the AI Sport Prediction FIFA World Cup 2026 forecasting benchmark. It is intended to guide the preregistered paper, the benchmark dataset, and the later engineering implementation in the existing web app.
...
The protocol should be integrated into the existing AI Sport Prediction/web app infrastructure rather than treated as a full rebuild.
