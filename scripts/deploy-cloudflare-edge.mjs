  ...
  containerDefinitions: [
    {
      ...
      environment: [
        ...
        { name: "WEB_API_PREDICTIONS_CACHE_SECONDS", value: env("WEB_API_PREDICTIONS_CACHE_SECONDS", "60") },
    ...
    },
    {
      ...
      environment: [
        ...
        { name: "API_CACHE_PREDICTIONS_TTL_SECONDS", value: env("API_CACHE_PREDICTIONS_TTL_SECONDS", "60") },
    ...
    },
    {
      ...
      environment: [
        ...
        ["PREDICTION_AUTOMATION_MAX_FIXTURES_PER_RUN", env("PREDICTION_AUTOMATION_MAX_FIXTURES_PER_RUN", "500")],
