...
export type TennisTournament = {
  slug: string;
  name: string;
  category: "Grand Slam" | "ATP 1000" | "WTA 1000" | "Finals" | "Team" | "ATP 500" | "WTA 500";
...
export const tennisPlayers: TennisPlayer[] = [
  { slug: "jannik-sinner", name: "Jannik Sinner", shortName: "Sinner", tour: "ATP", country: "Italy", countryCode: "it", rank: 1, age: 24, hand: "Right-handed", height: "1.91 m", turnedPro: "2018", residence: "Monte Carlo", coach: "Simone Vagnozzi / Darren Cahill", titles: 19, grandSlams: 3, hard: 95, clay: 84, grass: 82, indoor: 91, form: "W W W L W", prediction: "Baseline pressure and return depth keep him top of the model.", strengths: ["Return pressure", "Backhand stability", "Hard-court tempo"] },
  ...
  { slug: "holger-rune", name: "Holger Rune", shortName: "Rune", tour: "ATP", country: "Denmark", countryCode: "dk", rank: 12, age: 23, hand: "Right-handed", height: "1.88 m", turnedPro: "2020", residence: "Monte Carlo", coach: "Team Rune", titles: 4, grandSlams: 0, hard: 80, clay: 84, grass: 75, indoor: 83, form: "W L L W W", prediction: "Aggressive baseline timing keeps him volatile but dangerous in big events.", strengths: ["Backhand aggression", "Indoor timing", "Return position"] },
  { slug: "stefanos-tsitsipas", name: "Stefanos Tsitsipas", shortName: "Tsitsipas", tour: "ATP", country: "Greece", countryCode: "gr", rank: 13, age: 27, hand: "Right-handed", height: "1.93 m", turnedPro: "2016", residence: "Monte Carlo", coach: "Apostolos Tsitsipas", titles: 12, grandSlams: 0, hard: 80, clay: 88, grass: 72, indoor: 79, form: "W L W L W", prediction: "Clay-court offense and net instincts keep him dangerous in slower draws.", strengths: ["Clay forehand", "Net play", "Serve plus one"] },
  ...
  { slug: "emma-navarro", name: "Emma Navarro", shortName: "Navarro", tour: "WTA", country: "United States", countryCode: "us", rank: 10, age: 25, hand: "Right-handed", height: "1.70 m", turnedPro: "2019", residence: "Charleston", coach: "Team Navarro", titles: 1, grandSlams: 0, hard: 82, clay: 80, grass: 78, indoor: 77, form: "L W W W L", prediction: "Consistency and court craft keep her projected floor high.", strengths: ["Court craft", "Consistency", "Point tolerance"] },
  { slug: "naomi-osaka", name: "Naomi Osaka", shortName: "Osaka", tour: "WTA", country: "Japan", countryCode: "jp", rank: 11, age: 28, hand: "Right-handed", height: "1.80 m", turnedPro: "2013", residence: "Los Angeles", coach: "Team Osaka", titles: 7, grandSlams: 4, hard: 88, clay: 70, grass: 73, indoor: 80, form: "W L L W W", prediction: "Hard-court serve and first-strike power remain high-impact signals.", strengths: ["Hard-court serve", "First strike", "Major experience"] },
  { slug: "ons-jabeur", name: "Ons Jabeur", shortName: "Jabeur", tour: "WTA", country: "Tunisia", countryCode: "tn", rank: 12, age: 31, hand: "Right-handed", height: "1.67 m", turnedPro: "2010", residence: "Sousse", coach: "Issam Jellali", titles: 5, grandSlams: 0, hard: 78, clay: 80, grass: 86, indoor: 76, form: "L W L W L", prediction: "Variety and grass-court creativity make her a matchup-sensitive threat.", strengths: ["Variety", "Drop shots", "Grass creativity"] },
...
export const tennisTournaments: TennisTournament[] = [
  { slug: "australian-open", name: "Australian Open", category: "Grand Slam", surface: "Hard", location: "Melbourne", countryCode: "au", month: "January", draw: "128 singles", importance: 100 },
  { slug: "roland-garros", name: "Roland-Garros", category: "Grand Slam", surface: "Clay", location: "Paris", countryCode: "fr", month: "May/June", draw: "128 singles", importance: 100 },
  { slug: "wimbledon", name: "Wimbledon", category: "Grand Slam", surface: "Grass", location: "London", countryCode: "gb", month: "June/July", draw: "128 singles", importance: 100 },
  { slug: "us-open", name: "US Open", category: "Grand Slam", surface: "Hard", location: "New York", countryCode: "us", month: "August/September", draw: "128 singles", importance: 100 },
  { slug: "atp-finals", name: "ATP Finals", category: "Finals", surface: "Indoor hard", location: "Turin", countryCode: "it", month: "November", draw: "Top 8", importance: 94 },
  { slug: "wta-finals", name: "WTA Finals", category: "Finals", surface: "Hard", location: "Riyadh", countryCode: "sa", month: "November", draw: "Top 8", importance: 94 },
  { slug: "indian-wells", name: "Indian Wells", category: "ATP 1000", surface: "Hard", location: "Indian Wells", countryCode: "us", month: "March", draw: "96 singles", importance: 88 },
  { slug: "miami-open", name: "Miami Open", category: "ATP 1000", surface: "Hard", location: "Miami", countryCode: "us", month: "March", draw: "96 singles", importance: 88 },
  { slug: "monte-carlo", name: "Monte-Carlo Masters", category: "ATP 1000", surface: "Clay", location: "Monte Carlo", countryCode: "mc", month: "April", draw: "56 singles", importance: 86 },
  { slug: "madrid-open", name: "Madrid Open", category: "WTA 1000", surface: "Clay", location: "Madrid", countryCode: "es", month: "April/May", draw: "96 singles", importance: 88 },
  { slug: "italian-open", name: "Italian Open", category: "WTA 1000", surface: "Clay", location: "Rome", countryCode: "it", month: "May", draw: "96 singles", importance: 88 },
  { slug: "canadian-open", name: "Canadian Open", category: "ATP 1000", surface: "Hard", location: "Toronto/Montreal", countryCode: "ca", month: "August", draw: "56 singles", importance: 86 },
  { slug: "cincinnati-open", name: "Cincinnati Open", category: "WTA 1000", surface: "Hard", location: "Cincinnati", countryCode: "us", month: "August", draw: "56 singles", importance: 86 },
  { slug: "shanghai-masters", name: "Shanghai Masters", category: "ATP 1000", surface: "Hard", location: "Shanghai", countryCode: "cn", month: "October", draw: "96 singles", importance: 86 },
  { slug: "paris-masters", name: "Paris Masters", category: "ATP 1000", surface: "Indoor hard", location: "Paris", countryCode: "fr", month: "October/November", draw: "56 singles", importance: 86 },
  { slug: "qatar-open", name: "Qatar Open", category: "WTA 1000", surface: "Hard", location: "Doha", countryCode: "qa", month: "February", draw: "56 singles", importance: 84 },
  { slug: "dubai-tennis-championships", name: "Dubai Tennis Championships", category: "WTA 1000", surface: "Hard", location: "Dubai", countryCode: "ae", month: "February", draw: "56 singles", importance: 84 },
  { slug: "china-open", name: "China Open", category: "WTA 1000", surface: "Hard", location: "Beijing", countryCode: "cn", month: "September/October", draw: "96 singles", importance: 84 },
  { slug: "wuhan-open", name: "Wuhan Open", category: "WTA 1000", surface: "Hard", location: "Wuhan", countryCode: "cn", month: "October", draw: "56 singles", importance: 84 },
  { slug: "davis-cup", name: "Davis Cup", category: "Team", surface: "Hard", location: "Finals", countryCode: "xx", month: "November", draw: "National teams", importance: 82 },
  { slug: "billie-jean-king-cup", name: "Billie Jean King Cup", category: "Team", surface: "Hard", location: "Finals", countryCode: "xx", month: "November", draw: "National teams", importance: 82 },
  { slug: "united-cup", name: "United Cup", category: "Team", surface: "Hard", location: "Australia", countryCode: "au", month: "January", draw: "Mixed teams", importance: 78 },
  { slug: "queen-s-club", name: "Queen's Club", category: "ATP 500", surface: "Grass", location: "London", countryCode: "gb", month: "June", draw: "32 singles", importance: 72 },
  { slug: "halle-open", name: "Halle Open", category: "ATP 500", surface: "Grass", location: "Halle", countryCode: "de", month: "June", draw: "32 singles", importance: 72 },
  { slug: "barcelona-open", name: "Barcelona Open", category: "ATP 500", surface: "Clay", location: "Barcelona", countryCode: "es", month: "April", draw: "48 singles", importance: 72 },
  { slug: "stuttgart-open", name: "Stuttgart Open", category: "WTA 500", surface: "Clay", location: "Stuttgart", countryCode: "de", month: "April", draw: "32 singles", importance: 72 },
  { slug: "berlin-open", name: "Berlin Open", category: "WTA 500", surface: "Grass", location: "Berlin", countryCode: "de", month: "June", draw: "32 singles", importance: 72 }
];

export function getTennisPlayer(slug: string) {
