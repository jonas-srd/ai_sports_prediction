...
export const metadata: Metadata = {
  ...
  description: "Project overview, methodology, scoring, and limitations of AI Sport Prediction."
};
...
const aboutPoints = [
  {
    label: "What this is",
    text: "AI Sport Prediction is a live football prediction benchmark for artificial intelligence. During the 2026 FIFA World Cup, leading AI language models predict matches and tournament outcomes, and we compare those forecasts with the official results."
  },
  {
    label: "The question",
  ...
  return (
    <main className="shell aboutShell">
      ...
      <nav className="aboutAnchorNav" aria-label="About page sections">
        <a href="#about">About AI Sport Prediction</a>
      ...
      <header className="aboutSectionHeader" id="about">
        ...
        <h2>About AI Sport Prediction</h2>
      ...
      <header className="aboutSectionHeader" id="team">
        ...
        <h2>Team</h2>
        <p>The researchers and contributors behind AI Sport Prediction.</p>
      </header>
