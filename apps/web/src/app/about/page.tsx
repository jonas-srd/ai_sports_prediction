...
export const metadata: Metadata = {
  title: "About | Residual Sports",
  description: "About the Residual Sports platform for football, NFL, NBA and tennis forecasts."
};
    ...
    <main className="shell aboutShell">
      ...
      <section className="sportsHubSection">
        <div className="sectionHeaderRow">
          ...
          <p>
            Residual Sports starts with football and expands into the sports where model signals,
