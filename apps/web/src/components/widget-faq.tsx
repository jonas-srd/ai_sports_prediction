...
const homeEntriesByLocale: Record<Locale, FaqEntry[]> = {
  de: [
    ["Ist AI Sports Prediction für Sportwetten gedacht?", "Nein. Wir stellen ausschließlich Informationen bereit: Modellprognosen, Wahrscheinlichkeiten, Ergebnisideen und nachvollziehbare Begründungen. Das ist keine Wettberatung, keine Aufforderung zum Wetten und keine Garantie für einen bestimmten Ausgang."],
  ...
  en: [
    ["Is AI Sports Prediction intended for sports betting?", "No. We provide information only: model forecasts, probabilities, score ideas and explainable reasoning. This is not betting advice, an invitation to bet or a guarantee of any outcome."],
