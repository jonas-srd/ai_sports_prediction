...
const DASHBOARD_TEXT = {
  en: {
    ...
    questionDescription: "Long-range football tournament picks for group winners, semifinalists, top scorer team, and title paths.",
    ...
    questionHint: "Shown setup: Open Book / Probabilistic Forecast / STAGE_OPENING. Correct future tips get 5 points; wrong or unresolved tips get 0.",
    rank: "Rank",
    model: "Model",
    score: "Score",
    actual: "Actual",
  ...
  de: {
    ...
    questionDescription: "Langfristige Fußball-Turnier-Tipps für Gruppensieger, Halbfinalisten, Top-Torschützen-Team und Titelpfade.",
    ...
    questionHint: "Angezeigtes Setup: Open Book / Probabilistic Forecast / STAGE_OPENING. Richtige Zukunftstipps erhalten 5 Punkte; falsche oder offene Tipps erhalten 0.",
    rank: "Rang",
    model: "Modell",
    score: "Punkte",
    actual: "Aktuell",
